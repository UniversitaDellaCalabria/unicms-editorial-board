<template>
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <b-card title="Carousel item links">
                        <b-card-text>
...
export default {
    ...
    methods: {
        callApi(url, page=null) {
            ...
            let source = '/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/links/?page=' + target_page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
        ...
        changeStatus(id) {
            ...
            this.axios
                .patch('/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/links/'+item.id+'/',
        ...
        remove(id) {
            this.axios
                .delete('/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/links/'+id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
        ...
        deleteModal(item) {
            this.$bvModal.msgBoxConfirm('Do you want really delete carousel item link '+item.title+'?', {
