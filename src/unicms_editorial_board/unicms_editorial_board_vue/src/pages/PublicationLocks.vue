<template>
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <b-card title="Publication locks">
                        <b-card-text>

                            <div class="pull-right mb-3">
                                <router-link :to="{ name: 'PublicationLockNew',
...
export default {
    ...
    methods: {
        callApi(url, page=null) {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    let source2 = '/api/editorial-board/locks/'+response.data.object_content_type+'/'+this.publication_id+'/?page=' + target_page + '&search=' + this.search;
                    this.axios
                        .get(source2)
                        .then(response2 => {
        ...
        remove(id) {
            this.axios
                .delete('/api/editorial-board/locks/'+this.content_type+'/'+this.publication_id+'/'+id+'/',
