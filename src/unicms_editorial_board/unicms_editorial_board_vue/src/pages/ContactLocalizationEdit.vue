                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'ContactLocalizationLogs',
...
export default {
    data() {
        return {
            ...
            form: {},
            form_source: '/api/editorial-board/contacts/'+this.$route.params.contact_id+'/localizations/form/',
            page_title: '',
            redis_alert: null,
            interval: null,
        }
    ...
    methods: {
        ...
        getItem() {
            let source = '/api/editorial-board/contacts/'+this.$route.params.contact_id+'/localizations/'+this.localization_id+'/';
            this.axios
                .get(source)
                .then(response => {
        ...
        onSubmit(event) {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    this.alerts.push(
                        { variant: 'success',
                          message: 'contact localization edited successfully',
                          dismissable: true }
                    );
        ...
        remove() {
            this.axios
                .delete('/api/editorial-board/contacts/'+this.contact_id+'/localizations/'+this.localization_id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
                    this.alerts.push(
                        { variant: 'success',
                          message: 'contact localization removed successfully',
                          dismissable: true }
                    );
                    this.$router.push({name: 'ContactLocalizations',
        ...
        deleteModal() {
            this.$bvModal.msgBoxConfirm('Do you want really delete contact localization?', {
