                            ...
                            <b-table
                                ...
                                <template #cell(actions)="data">
                                    <router-link :to="{ name: 'CarouselItemLocalizationEdit',
                                                    params: { carousel_id: carousel_id,
                                                              carousel_item_id: carousel_item_id,
                                                              carousel_item_localization_id: data.item.id}}"
...
export default {
    ...
    methods: {
        callApi(url, page=null) {
            ...
            let source = '/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/localizations/?page=' + target_page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
