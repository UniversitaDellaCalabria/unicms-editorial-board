                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'WebpathPageMediaCollectionLogs',
...
export default {
    data() {
        return {
            ...
            form: {},
            files: {},
            form_source: '/api/editorial-board/sites/'+this.$route.params.site_id+'/webpaths/'+this.$route.params.webpath_id+'/pages/'+this.$route.params.page_id+'/media-collections/form/',
    ...
    methods: {
        ...
        getItem() {
            let source = '/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/media-collections/'+this.collection_id+'/';
            this.axios
                .get(source)
                .then(response => {
        ...
        onSubmit(event) {
            ...
            this.axios
                ...
                .then(response => {
                    this.alerts.push(
                        { variant: 'success',
                          message: 'page media collection edited successfully',
                          dismissable: true }
                    )
        ...
        remove() {
            this.axios
                ...
                .then(response => {
                    this.alerts.push(
                        { variant: 'success',
                          message: 'page media collection removed successfully',
                          dismissable: true }
                    );
                    this.$router.push({name: 'WebpathPageMediaCollections',
        ...
        deleteModal() {
            this.$bvModal.msgBoxConfirm('Do you want really delete page media collection?', {
