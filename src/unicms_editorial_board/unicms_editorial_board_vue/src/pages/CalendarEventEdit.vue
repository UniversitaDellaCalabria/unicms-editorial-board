                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'CalendarEventLogs',
...
export default {
    data() {
        return {
            ...
            calendar_event_id: this.$route.params.calendar_event_id,
            form: {},
            form_source: '/api/editorial-board/calendars/'+this.$route.params.calendar_id+'/events/form/',
            add_modal_fields: {'event': this.$router.resolve({name: 'EventNew'}).href},
            page_title: '',
            redis_alert: null,
            interval: null,
        }
    ...
    methods: {
        ...
        getItem() {
            let source = '/api/editorial-board/calendars/'+this.calendar_id+'/events/'+this.calendar_event_id+'/';
            this.axios
                .get(source)
                .then(response => {
                    ...
                    let params = {'content_type_id': obj_content_type,
                                  'object_id': this.calendar_event_id}
        ...
        onSubmit(event) {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    this.page_title = response.data.event.publication_data.title;
        ...
        remove() {
            this.axios
                .delete('/api/editorial-board/calendars/'+this.calendar_id+'/events/'+this.calendar_event_id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
                    this.alerts.push(
        ...
        deleteModal() {
            this.$bvModal.msgBoxConfirm('Do you want really delete calendar event?', {
