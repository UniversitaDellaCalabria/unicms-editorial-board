                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'CarouselItemLocalizationLogs',
                                            params: { carousel_id: carousel_id,
                                                              carousel_item_id: carousel_item_id,
                                                              carousel_item_localization_id: carousel_item_localization_id }}"
...
export default {
    ...
    methods: {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    let params = {'content_type_id': obj_content_type,
                                  'object_id': this.carousel_item_localization_id}
        ...
        remove() {
            this.axios
                .delete('/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/localizations/'+this.carousel_item_localization_id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
                    this.alerts.push(
