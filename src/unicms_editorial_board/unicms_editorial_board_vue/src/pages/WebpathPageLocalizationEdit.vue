                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'WebpathPageLocalizationLogs',
...
export default {
    ...
    methods: {
        setData(data) {
            ...
            this.page_title = data.localization.title;
        },
        getItem() {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    let api_lock_src = '/api/editorial-board/redis-lock/'+obj_content_type+'/'+this.localization_id+'/set/';
