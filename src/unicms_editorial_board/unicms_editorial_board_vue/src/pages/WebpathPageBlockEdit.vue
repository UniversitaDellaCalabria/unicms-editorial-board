                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'WebpathPageBlockLogs',
...
export default {
    ...
    methods: {
        setData(data) {
            ...
            this.$set(this.files, 'block', data.block.image);
            this.page_title = data.block.name;
        },
        getItem() {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    let api_lock_src = '/api/editorial-board/redis-lock/'+obj_content_type+'/'+this.block_id+'/set/';
