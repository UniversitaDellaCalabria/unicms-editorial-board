                    ...
                    <b-card title="Page medias">
                        <b-card-text>
                            ...
                            <b-table
                                ...
                                <template #cell(media.file)="data">
                                    <b-img :src="data.value" fluid alt="Responsive image"></b-img>
                                </template>
                                ...
                                <template #cell(actions)="data">
                                    <router-link :to="{ name: 'MediaEdit',
                                                        params: { media_id: data.item.media.id }}"
...
export default {
    data () {
        return {
            ...
            fields: [
                {key: 'media.title', label: 'Media', sortable: true},
                {key: 'media.file', label: 'File', sortable: true},
    ...
    methods: {
        callApi(url, page=null) {
            ...
            let source = '/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/medias/?page=' + target_page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
        ...
        changeStatus(id) {
            ...
            this.axios
                .patch('/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/medias/'+item.id+'/',
        ...
        remove(id) {
            this.axios
                .delete('/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/medias/'+id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
        ...
        deleteModal(item) {
            this.$bvModal.msgBoxConfirm('Do you want really delete media?', {
