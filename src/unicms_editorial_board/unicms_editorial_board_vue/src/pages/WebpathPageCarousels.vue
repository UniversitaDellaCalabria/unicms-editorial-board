                            ...
                            <b-table
                                ...
                                <template #cell(actions)="data">
                                    <router-link :to="{ name: 'CarouselEdit',
                                                        params: { carousel_id: data.item.carousel.id }}"
...
export default {
    data () {
        return {
            ...
            fields: [
                {key: 'carousel.name', label: 'Carousel', sortable: true},
    ...
    methods: {
        callApi(url, page=null) {
            ...
            let source = '/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/carousels/?page=' + target_page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
        ...
        changeStatus(id) {
            ...
            this.axios
                .patch('/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/carousels/'+item.id+'/',
                ...
                .then(response => {
                    ...
                    this.alerts.push(
                        { variant: 'success',
                          message: 'page carousel status changed successfully',
                          dismissable: true }
                    )}
                )
                .catch(error => {
        ...
        remove(id) {
            this.axios
                .delete('/api/editorial-board/sites/'+this.site_id+'/webpaths/'+this.webpath_id+'/pages/'+this.page_id+'/carousels/'+id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
