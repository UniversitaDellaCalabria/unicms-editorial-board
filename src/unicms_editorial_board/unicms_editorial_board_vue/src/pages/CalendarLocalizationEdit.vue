                ...
                <div class="col-12">
                    <b-card>
                        <div class="clearfix mb-5">
                            <div class="pull-left">
                                <router-link :to="{ name: 'CalendarLocalizationLogs',
                                            params: { calendar_id: calendar_id,
                                                      calendar_localization_id: calendar_localization_id }}"
...
export default {
    data() {
        return {
            ...
            calendar_localization_id: this.$route.params.calendar_localization_id,
            form: {},
    ...
    methods: {
        ...
        getItem() {
            let source = '/api/editorial-board/calendars/'+this.$route.params.calendar_id+'/localizations/'+this.calendar_localization_id+'/';
            this.axios
                .get(source)
                .then(response => {
                    ...
                    let params = {'content_type_id': obj_content_type,
                                  'object_id': this.calendar_localization_id}
        ...
        onSubmit(event) {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    this.alerts.push(
                        { variant: 'success',
                          message: 'calendar localization edited successfully',
                          dismissable: true }
                    );
        ...
        remove() {
            this.axios
                .delete('/api/editorial-board/calendars/'+this.calendar_id+'/localizations/'+this.calendar_localization_id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
                    this.alerts.push(
                        { variant: 'success',
                          message: 'calendar localization removed successfully',
                          dismissable: true }
                    );
        ...
        deleteModal() {
            this.$bvModal.msgBoxConfirm('Do you want really delete calendar localization?', {
