...
export default {
    ...
    methods: {
        ...
        getItem() {
            ...
            this.axios
                ...
                .then(response => {
                    ...
                    let api_lock_src = '/api/editorial-board/redis-lock/'+obj_content_type+'/'+this.carousel_item_link_localization_id+'/set/';
                    this.axios.get(api_lock_src);
                    this.$user_is_active(api_lock_src);
                    this.interval = setInterval(() => {
                        this.$checkForRedisLocks(obj_content_type,
                                                 this.carousel_item_link_localization_id);
        ...
        deleteModal() {
            this.$bvModal.msgBoxConfirm('Do you want really delete carousel item link localization?', {
