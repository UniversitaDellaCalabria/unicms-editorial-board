...
export default {
    ...
    methods: {
        callApi(url, page=null) {
            ...
            let source = '/api/editorial-board/carousels/?page=' + target_page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
        ...
        changeStatus(id) {
            ...
            this.axios
                .patch('/api/editorial-board/carousels/'+item.id+'/',
        ...
        remove(id) {
            this.axios
                .delete('/api/editorial-board/carousels/'+id+'/',
                        {headers: {"X-CSRFToken": this.$csrftoken }}
                       )
                .then(response => {
        ...
        deleteModal(item) {
            this.$bvModal.msgBoxConfirm('Do you want really delete carousel ' + item.name + '?', {
