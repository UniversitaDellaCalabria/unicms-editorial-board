...
export default {
    ...
    methods: {
        ...
        callApi(url) {
            let source = '/api/editorial-board/carousels/'+this.carousel_id+'/items/'+this.carousel_item_id+'/links/'+this.carousel_item_link_id+'/localizations/?page=' + this.page + '&search=' + this.search;
            if (url) source = url;
            this.axios
                .get(source)
                .then(response => {
